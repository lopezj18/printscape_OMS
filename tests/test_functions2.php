...
function test_user_orders(){
	$user_orders = array();

	$i = 0;

	$user_orders[$i]['user_id'] = 150;
	$user_orders[$i]['order_id'] = 22;

	$i++;

	$user_orders[$i]['user_id'] = 3;
	$user_orders[$i]['order_id'] = 23;

	$i++;

	$user_orders[$i]['user_id'] = 10;
	$user_orders[$i]['order_id'] = 24;

	$i++;
	
	$user_orders[$i]['user_id'] = 11;
	$user_orders[$i]['order_id'] = 25;

	$i++;

	$user_orders[$i]['user_id'] = 12;
	$user_orders[$i]['order_id'] = 26;

	$i++;

	$user_orders[$i]['user_id'] = 18;
	$user_orders[$i]['order_id'] = 27;

	$i++;

	$user_orders[$i]['user_id'] = 148;
	$user_orders[$i]['order_id'] = 28;
